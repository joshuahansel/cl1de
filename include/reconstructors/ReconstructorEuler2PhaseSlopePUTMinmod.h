#ifndef ReconstructorEuler2PhaseSlopePUTMinmod_H
#define ReconstructorEuler2PhaseSlopePUTMinmod_H

#include "ReconstructorEuler2PhaseSlopePUT.h"

class EOS1Phase;

class ReconstructorEuler2PhaseSlopePUTMinmod : public ReconstructorEuler2PhaseSlopePUT
{
public:
  ReconstructorEuler2PhaseSlopePUTMinmod(
...
#endif /* ReconstructorEuler2PhaseSlopePUTMinmod_H */
