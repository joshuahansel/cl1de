...
int main(int argc, char* argv[])
{
  ...
  const double r_liq_L = 2.0;
  const double r_liq_R = 2.0;
  const double r_vap_L = 1.0;
  const double r_vap_R = 0.1941;
  const double u_liq_L = 0.3;
  const double u_liq_R = 0.3;
  const double u_vap_L = 2.0;
  const double u_vap_R = 2.8011;
  const double p_liq_L = 5.0;
  const double p_liq_R = 12.8567;
  const double p_vap_L = 1.0;
  const double p_vap_R = 0.1;
